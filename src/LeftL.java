...
public class LeftL extends Shape {
	...
	public LeftL(int x, int y, int rightBoundary, int leftBoundary, int downBoundary, Orientation orientation) {
	...
	public int[][] getOccupiedSquares(int[] startSquareIndex) {
		...
		if (this.orientation == Orientation.UP) {
			...
			occupiedSquares[1] =  new int[] {startX + 1, startY + 1};
			occupiedSquares[2] =  new int[] {startX + 1, startY + 2};
			...
			occupiedSquares[0] =  new int[] {startX, startY};
			occupiedSquares[1] =  new int[] {startX + 2, startY + 1};
			occupiedSquares[2] =  new int[] {startX + 1, startY};
			occupiedSquares[3] =  new int[] {startX + 2, startY};
		} else if (this.orientation == Orientation.RIGHT) {
			occupiedSquares[0] =  new int[] {startX, startY};
			occupiedSquares[1] =  new int[] {startX + 2, startY + 1};
			occupiedSquares[2] =  new int[] {startX + 1, startY + 1};
			occupiedSquares[3] =  new int[] {startX, startY + 1};
		}
